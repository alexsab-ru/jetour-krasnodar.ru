...
cookiecook();
connectForms('https://alexsab.ru/lead/jetour/krasnodar/', {
...
grecaptcha.ready(function() {
	grecaptcha.execute('6Lepfy4pAAAAAAGHFP655qNe6Bb_BcskklcxajC6', {action: 'jetour_krasnodar'}).then(function(token) {
